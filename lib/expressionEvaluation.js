...
/* The value a parameter of a primitive type holds when nothing binds one, as
   given by https://obc.lbl.gov/specification/cdl.html#permissible-data-types */
const typeDefaults = {
  Boolean: 'false',
  Integer: '0',
  Real: '0.0',
 ...
 * is a better default than the one the data type carries. Failing that, the
 * data type default is used
 *
 * @param {Object} component - One component, as getComponents returns it
 * @returns {string|undefined} - The default binding, or undefined when neither
 *     the declaration nor the data type provides one
 */
function defaultAssignment (component) {
  ...
  return typeDefaults[component.typeSpecifier]
}
